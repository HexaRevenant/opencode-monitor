...
```powershell
npm install -g opencode-system-metrics-tui@0.1.20
opencode plugin -g opencode-system-metrics-tui@0.1.20 --force
```
...
```bash
opencode plugin opencode-system-metrics-tui@0.1.20
```
...
- `opencode plugin opencode-system-metrics-tui@0.1.20` lo instala solo en el proyecto actual.
- `opencode plugin -g opencode-system-metrics-tui@0.1.20 --force` lo instala globalmente para todos los proyectos.
...
- `opencode plugin opencode-system-metrics-tui@0.1.20` installs it for the current project only.
- `opencode plugin -g opencode-system-metrics-tui@0.1.20 --force` installs it globally for all projects.
...
- `opencode plugin opencode-system-metrics-tui@0.1.20` instala o plugin apenas no projeto atual.
- `opencode plugin -g opencode-system-metrics-tui@0.1.20 --force` instala o plugin globalmente para todos os projetos.
